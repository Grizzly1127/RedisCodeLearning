...
2. 第二阶段 熟悉Redis数据类型的实现
    ...
    - [字符串对象 t_string.c](./second_stage/Redis源码-字符串对象string.md)
    - [列表对象 t_list.c](./second_stage/Redis源码-列表对象list.md)
    - [散列对象 t_hash.c](./second_stage/Redis源码-散列对象hash.md)
    - [集合对象 t_set.c](./second_stage/Redis源码-集合对象set.md)
